...
<link rel="stylesheet" type="text/css"
	href="/carparking/src/main/webapp/WEB-INF/jsp/font-awesome.css">
<link rel="stylesheet" type="text/css"
	href="/carparking/src/main/webapp/WEB-INF/jsp/bootstrap.min.css">
<link rel="stylesheet" type="text/css"
	href="/carparking/src/main/webapp/WEB-INF/jsp/templatemo-training-studio.css" />
...
<body>
			...
			<div class="row">
				<div class="col-12">
					<nav class="main-nav">
						...
						<!-- ***** Menu Start ***** -->
						<ul class="nav">
							<li class="scroll-to-section"><a href="welcome"
	...
	<div class="main-banner" id="top">
		<img id="bg-video"
			src="https://media1.giphy.com/media/lOMZy4aUspzkA/giphy.gif"> </img>
	...
	<script type="text/javascript"
		src="/carparking/src/main/webapp/WEB-INF/jsp/jquery-2.1.0.min.js"></script>
	<script type="text/javascript"
		src="/carparking/src/main/webapp/WEB-INF/jsp/bootstrap.min.js"></script>

	<script type="text/javascript"
		src="/carparking/src/main/webapp/WEB-INF/jsp/scrollreveal.min.js"></script>
	<script type="text/javascript"
		src="/carparking/src/main/webapp/WEB-INF/jsp/jquery.counterup.min.js"></script>

	<script type="text/javascript"
		src="/carparking/src/main/webapp/WEB-INF/jsp/custom.js"></script>
